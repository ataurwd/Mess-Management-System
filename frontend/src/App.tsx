  ...
  return (
    <div className="flex min-h-screen bg-slate-950 text-slate-100 font-['Plus_Jakarta_Sans',sans-serif]">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top Navbar */}
        <header className="h-[4.5rem] bg-slate-900/60 border-b border-slate-800/80 backdrop-blur-md px-4 lg:px-8 flex items-center justify-between sticky top-0 z-30">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-base font-bold text-white tracking-tight ml-2 lg:ml-0">{getPageTitle(location.pathname)}</h2>
